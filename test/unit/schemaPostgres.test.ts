...
function stub(a: Function): SinonStub {
  return a as SinonStub;
}
...
describe('PostgresDatabase', () => {
  ...
  before((): void => {
    ...
    console.log('xxx', SchemaPostgres);
  ...
  describe('getTableTypes', () => {
    ...
    it('gets custom types from enums', async () => {
      ...
      stub(PostgresProxy.getTableDefinition).returns(Promise.resolve({}));
  ...
  describe('mapTableDefinitionToType', () => {
    ...
    describe('maps to Object', () => {
      it('json', () => {
        ...
        assert.equal(PostgresDBReflection.mapTableDefinitionToType(td, [], options).column.tsType, 'Record<string, any>');
      });
      it('jsonb', () => {
        const td: TableDefinition = {
          column: {
    ...
    describe('maps to Record<string, any>[]', () => {
      it('_json', () => {
        const td: TableDefinition = {
          column: {
            udtName: '_json',
